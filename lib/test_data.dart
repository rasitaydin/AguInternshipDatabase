...
class TestData{
  ...
  static final String student = "INSERT INTO student VALUES"
      "(1,'SÖNMEZ','ALEV','M','IE',5078541524,'sönmez.alev@test.com','N'),"
      "(2,'BİLGİ','SAYAR','F','COMP',5078511425,'bilgi.sayar@test.com','N'),"
      "(3,'ENES','MAZLUM','M','EEE',5094512365,'enes.mazlum@test.com','Y'),"
      "(4,'RABİA','FAN','F','EEE',5411254136,'rabia.fan@test.com','Y'),"
      "(5,'AFET','GÜÇLÜ','F','MBG',4514584125,'afet.güçlü@test.com','Y'),"
      "(6,'RAŞİT','AYMAZ','M','MBG',NULL,'raşit.aymaz@test.com','Y'),"
      "(7,'FAHRİ','İDDİA','M','BA',NULL,'fahri.iddia@test.com','Y'),"
      "(8,'FERHAT','GEN','M','BA',NULL,'ferhat.gen@test.com','N'),"
      "(9,'AHMET','FALAKA','M','IE',NULL,'ahmet.falaka@test.com','Y'),"
      "(10,'PEMBE','FÜNLÜ','F','COMP',5079536564,'pembe.fünlü@test.com','Y'),"
      "(11,'MURTAZA','ADIKONMAZ','M','ME',5023659854,'murtaza.adıkonmaz@test.com','Y'),"
      "(12,'ÜLKÜ','PORSUK','F','ME',5034667481,'ülkü.porsuk@test.com','Y'),"
      "(13,'SANYA','PANAŞ','F','IE',5307468412,'sanya.panaş@test.com','N'),"
      "(14,'BAHTSIZ','BEDEVİ','M','ME',5154115454,'bahtsız.bedevi@test.com','N'),"
      "(15,'SATILMIŞ','EV','M','CE',1102104578,'satılmış.ev@test.com','N'),"
      "(16,'KÜRŞAT','BAĞDÖKEN','M','CE',5078951421,'kürşat.bağdöken@test.com','N'),"
      "(17,'TAYLAN','VALHA','M','CE',NULL,'taylan.valha@test.com','N');";
